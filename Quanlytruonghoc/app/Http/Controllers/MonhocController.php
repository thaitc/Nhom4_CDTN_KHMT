...
class MonhocController extends Controller
{
    ...
    public function create()
    {
        ...
        $dsgiangvien = DB::table('giangvien')->select('id', 'tengiangvien')->get();
        //Hiển thị trang thêm mon hoc
        return view('monhoc.create')->with('dsgiangvien', $dsgiangvien);
    }
    ...
    public function edit($id)
    {
        ...
        $getData = DB::table('monhoc')->select('id', 'tenmon', 'tengiangvien', 'tinchi')->where('id', $id)->get();
        ...
        return view('monhoc.edit', ['getMonhocById' => $getData, 'dsgiangvien' => $dsgiangvien]);
    }
