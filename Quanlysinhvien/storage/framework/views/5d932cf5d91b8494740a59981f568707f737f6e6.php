  ...
  <header class="page-header">
    <nav>
      <a href="<?php echo e(url('/admin')); ?>">
        <img src="/Quanlytruonghoc/img/it.png" class="logo" style="width: 40%;" id="icon1" alt="Logo" />
      </a>
      ...
      <ul class="admin-menu">
        ...
        <li>
          <a href="<?php echo e(url('/admin/sinhvien')); ?>">
            <svg>
        ...
        <li>
          <a href="<?php echo e(url('/admin/giangvien')); ?>">
            <svg>
        ...
        <li>
          <a href="<?php echo e(url('/admin/monhoc')); ?>">
            <svg>
        ...
        <li>
          <a href="<?php echo e(url('/admin/admindiem')); ?>">
            <svg>
        ...
        <li>
          <a href="<?php echo e(url('/admin/danhgiagiangvien')); ?>">
            <svg>
              <use xlink:href="#pages"></use>
            </svg>
  ...
  <section class="page-content">
    <section class="search-and-user">
      ...
      <div class="admin-profile">
        <span class="greeting">Hello <?php echo e(Auth::user()->name); ?></span>|&ensp;
...
</script><?php /**PATH F:\xampp\htdocs\Quanlysinhvien\resources\views/templates/admin.blade.php ENDPATH**/ ?>