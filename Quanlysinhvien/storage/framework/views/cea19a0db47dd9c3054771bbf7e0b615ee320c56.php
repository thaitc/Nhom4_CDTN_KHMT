...
<div class="wrapper fadeInDown">
	<div id="formContent">
		...
		<form role="form" method="POST" action="<?php echo e(url('/register')); ?>">
			...
			<input placeholder="Mã sinh viên" class="fadeIn first" name="ma" type="text" value="<?php echo e(old('ma')); ?>" autofocus class="fadeIn ">
			<input placeholder="Họ và tên" name="name" type="text" value="<?php echo e(old('name')); ?>" autofocus>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\Quanlysinhvien\resources\views/auth/register.blade.php ENDPATH**/ ?>