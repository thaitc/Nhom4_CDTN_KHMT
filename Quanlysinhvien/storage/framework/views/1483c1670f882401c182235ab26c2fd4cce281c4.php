...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('ajaxItems.index')); ?>",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
        ...
        $('body').on('click', '.editItem', function() {
            ...
            $.get("<?php echo e(route('ajaxItems.index')); ?>" + '/' + Item_id + '/edit', function(data) {
        ...
        $('#saveBtn').click(function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('ajaxItems.store')); ?>",
                type: "POST",
                dataType: 'json',
        ...
        $('body').on('click', '.deleteItem', function() {
            ...
            $.ajax({
                type: "DELETE",
                url: "<?php echo e(route('ajaxItems.store')); ?>" + '/' + Item_id,
                success: function(data) {
                    table.draw();
                },
                error: function(data) {
...
</html><?php /**PATH F:\xampp\htdocs\thaitc\resources\views/itemAjax.blade.php ENDPATH**/ ?>